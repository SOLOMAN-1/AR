  ...
  const foodItems = [
    {
      ...
      modelSrc: "/mnt/data/realistic_burger.glb",
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg max-h-[90vh] flex flex-col shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <div className="relative bg-gray-50 w-full h-[450px]">
              <model-viewer src="/realistic_burger_fixed.glb"
               camera-controls 
               auto-rotate 
               ar 
  ...
  ar-modes="scene-viewer webxr"
   ar-placement="floor"
    ar-scale="fixed"
     shadow-intensity="1"
  shadow-softness="1"
  camera-target="20m 25m 2m"
  camera-orbit="75deg 75deg 2.5m"
  field-of-view="90deg"
...
> <button
  ...
  environment-image="https://modelviewer.dev/shared-assets/environments/restaurant.hdr"
  exposure="1.2"
  shadow-intensity="1"
  shadow-softness="1"
